...
[application access tokens](/platfrom-components/application-access-tokens) and
[personal access tokens](/platfrom-components/personal-access-tokens) in the
platform you can use to close off access to the entire API.
...
2. **Application Access Token**: Generate this by following our
   [Application Access Tokens guide](/platfrom-components/application-access-tokens)
