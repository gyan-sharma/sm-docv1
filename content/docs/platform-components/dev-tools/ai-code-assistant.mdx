...
![SettleMint Blockchain RooCode AI](../../../img/building-with-settlemint/roocode.png)
...
- Extensibility via MCP: RooCode supports the Model Context Protocol (MCP) ￼, a
  ...
  server)[https://console.settlemint.com/documentation/building-with-settlemint/dev-tools/mcp].
