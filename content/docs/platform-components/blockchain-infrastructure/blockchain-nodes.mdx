...
security and decentralization. On the other hand, **permissioned EVM blockchains**, such as **Quorum and
Hyperledger Besu**, restrict participation to authorized entities. These
networks prioritize privacy, regulatory compliance, and efficiency, often using
**Proof of Authority (PoA)** or **Istanbul Byzantine Fault Tolerance (IBFT)** to
validate transactions. Whether public or permissioned, all EVM-based blockchains
rely on a distributed set of nodes to maintain state synchronization and network
security.
...
entities can operate nodes, validate transactions, and access network data. Fabric’s modular architecture allows organizations to define governance models,
...
![Nodes List](../../../img/building-with-settlemint/node-list.png)
...
![EVM Node Info](../../../img/building-with-settlemint/evm-node-info.png)
...
![EVM Node Stats](../../../img/building-with-settlemint/evm-node-stats.png)

### Node Identity (EVM Chains)

![EVM Node Identity](../../../img/building-with-settlemint/evm-node-identity.png)
...
![EVM Node Connection](../../../img/building-with-settlemint/evm-node-connection.png)
...
![Node JSON RPC](../../../img/building-with-settlemint/node-jsonrpc.png)
...
![Node GraphQL](../../../img/building-with-settlemint/node-graphql.png)
...
![Node Resources](../../../img/building-with-settlemint/node-resources.png)
...
![EVM Node Logs](../../../img/building-with-settlemint/evm-node-logs.png)
...
![Fabric Node Info](../../../img/building-with-settlemint/fabric-node-info.png)
...
![Fabric Node Connection](../../../img/building-with-settlemint/fabric-node-connection.png)
...
![Fabric Node Stats](../../../img/building-with-settlemint/fabric-node-stats.png)
...
![Fabric Node Identity](../../../img/building-with-settlemint/fabric-node-identity.png)
...
![Fabric Node Logs](../../../img/building-with-settlemint/fabric-node-logs.png)
