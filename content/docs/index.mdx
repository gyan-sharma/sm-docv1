...
enterprise-grade blockcahin applications. It streamlines blockchain adoption
...
![SettleMint Platform](../img/building-with-settlemint/platform.png)
...
- **Hyperledger Besu** A highly popular permissioned blockchain framework
  ...
  control with IBFT and QBFT consensus.
